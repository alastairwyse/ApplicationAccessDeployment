...
curl -O https://raw.githubusercontent.com/alastairwyse/ApplicationAccess/refs/heads/main/ApplicationAccess.Persistence.Sql.SqlServer/Resources/CreateDatabase.sql
